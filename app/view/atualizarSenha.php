...
<body>
  ...
  <div class="container">
    <div class="content">
      <!--FORMULÁRIO DE LOGIN-->
      <div id="login">
        <form method="post" id="atualizar" data-action="log">
          ...
          <p>
            ...
            <input id="confirma_senha" name="senha_login" required="required" type="password" placeholder="digite a senha" data-validate="password" />
            <span class="error"></span>
          </p>
          <p>
            <input type="submit" class="btn-sub" value="Atualizar Senha" disabled />
          </p>
          <div id="alerta">
          </div>
        </form>
